...
mod test{
  ...
  #[test]
  fn test_equal_quats() {
      assert!(na::approx_eq( &Quat::new(1.0f64, 2.0, 3.0, 4.0), &Quat::new(1.0f64, 2.0, 3.0, 4.0) ));
  }
  ...
  fn test_update_known_vals() {
    ...
    assert!(na::approx_eq( &ahrs.Quaternion, &Quat::new( 0.999750219795400f64,
                                                        -0.015666683681890,
                                                        -0.015939041422266,
