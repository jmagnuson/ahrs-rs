...
impl AHRS {
  ...
  pub fn default() -> AHRS {
    AHRS { SamplePeriod: (1.0f64)/(256.0f64), Quaternion: Quat::new(1.0f64, 0.0, 0.0, 0.0),
           Kp: 1.0f64, Ki: 0.0f64, KpInit: 1.0, InitPeriod: 5.0f64, q: Quat::new(1.0f64, 0.0, 0.0, 0.0),
           IntError: Vec3::new(0.0f64, 0.0, 0.0), KpRamped: 0.0f64, Beta: 1.0f64
         }
  }
